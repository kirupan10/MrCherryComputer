                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <dd class="text-2xl font-bold text-gray-900">LKR {{ number_format($totalSales, 2) }}
                                </dd>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5">
                                ...
                                <dd class="text-2xl font-bold text-gray-900">LKR {{ number_format($todaySales, 2) }}
                                </dd>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse($recentSales as $sale)
                                        <tr>
                                            ...
                                            <td class="px-3 py-2 text-sm text-gray-900 text-right">LKR
                                                {{ number_format($sale->total_amount, 2) }}
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="3" class="px-3 py-4 text-sm text-gray-500 text-center">No recent
                                                sales</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                        ...
                        <div class="overflow-hidden">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <tbody class="divide-y divide-gray-200">
                                    @forelse($lowStockProducts as $product)
                                        <tr>
                                            ...
                                            <td class="px-3 py-2 text-sm text-right">
                                                <span
                                                    class="text-red-600 font-semibold">{{ optional($product->stock)->quantity ?? 0 }}</span>
                                            </td>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="3" class="px-3 py-4 text-sm text-gray-500 text-center">No low stock
                                                items</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="px-3 py-4 text-sm text-gray-500 text-center">No sales yet
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            <div class="mt-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                    @foreach($quickActions as $action)
                        <a href="{{ $action['route'] }}"
                            class="flex flex-col items-center p-4 bg-white shadow-sm hover:shadow-md rounded-lg transition">
                            <svg class="h-8 w-8 {{ $action['iconClass'] }} mb-2" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
