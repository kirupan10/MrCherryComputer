            ...
            <div class="bg-white shadow-sm rounded-lg p-4 mb-6">
                <form method="GET" action="{{ route('customers.index') }}" class="flex gap-4">
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Search by name, email, or phone..." class="flex-1 border-gray-300 rounded-lg">
                    <button type="submit"
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Total Purchases
                            </th>
                        ...
                        @forelse($customers as $customer)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">
                                    LKR {{ number_format($customer->sales_sum_total_amount ?? 0, 2) }}
                                </td>
