                            ...
                            <tbody id="salesTableBody">
                                @foreach($ordersWithProfit as $index => $item)
                                    ...
                                    <tr class="{{ $isHidden ? 'sales-row-hidden' : '' }}" data-row-index="{{ $index }}" data-invoice="{{ $order->invoice_no }}">
                                        ...
                                        <td>
                                            <a href="{{ shop_route('orders.show', $order) }}" class="text-reset text-decoration-none">
                        ...
                        @if(count($salesOrders) > 0)
                                ...
                                <table class="table table-vcenter card-table table-sm">
                                    ...
                                    <tbody>
                                        @foreach($salesOrders->take(10) as $order)
                                            <tr>
                                                <td><a href="{{ shop_route('orders.show', $order) }}">{{ $order->invoice_no }}</a></td>
                            ...
                            @if(count($salesOrders) > 10)
                                <div class="card-footer text-center">
                                    <a href="{{ shop_route('orders.index') }}" class="text-muted">View all {{ count($salesOrders) }} orders ?</a>
                                </div>
                            @endif
                        @else
                    ...
                    <div class="card-body p-0">
                        @if(count($expenseRecords) > 0)
                                ...
                                <table class="table table-vcenter card-table table-sm">
                                    ...
                                    <tbody>
                                        @foreach($expenseRecords->take(10) as $expense)
                                            <tr>
                                                <td><a href="{{ shop_route('expenses.edit', $expense) }}">{{ $expense->type }}</a></td>
                            ...
                            @if(count($expenseRecords) > 10)
                                <div class="card-footer text-center">
                                    <a href="{{ shop_route('expenses.index') }}" class="text-muted">View all {{ count($expenseRecords) }} expenses ?</a>
                                </div>
                            @endif
                        @else
                    ...
                    <div class="card-body p-0">
                        @if(count($businessTransactions) > 0)
                                ...
                                <table class="table table-vcenter card-table table-sm">
                                    ...
                                    <tbody>
                                        @foreach($businessTransactions->take(10) as $transaction)
                                            <tr>
                                                <td><a href="{{ shop_route('business-transactions.show', $transaction) }}">{{ ucfirst($transaction->transaction_type) }}</a></td>
                            ...
                            @if(count($businessTransactions) > 10)
                                <div class="card-footer text-center">
                                    <a href="{{ shop_route('business-transactions.index') }}" class="text-muted">View all {{ count($businessTransactions) }} transactions ?</a>
                                </div>
                            @endif
                        @else
