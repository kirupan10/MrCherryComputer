...
<div class="page-body">
    <div class="container-fluid">
        ...
        <form id="editOrderForm" action="{{ shop_route('orders.update', $order) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-lg-8">
                    <div class="card">
                                    ...
                                    <table class="table table-bordered" id="productsTable">
                                        ...
                                        <tbody id="productRows">
                                            ...
                                            <tr class="product-row" data-index="{{ $index }}">
                                                ...
                                                <td>
                                                    <input type="number" name="products[{{ $index }}][quantity]" class="form-control quantity-input" value="{{ $detail->quantity }}" min="1" step="1" required>
                                                </td>
                                                <td>
                        ...
                        <div class="card-footer text-end">
                            <a href="{{ shop_route('orders.index') }}" class="btn btn-secondary">
                                {{ __('Cancel') }}
                            </a>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (addCustomerBtn) {
            addCustomerBtn.addEventListener('click', function(e) {
                ...
                window.open('{{ shop_route("customers.create") }}', '_blank');
            });
        }
        ...
        function createProductRow(index) {
            ...
            return `
                <tr class="product-row" data-index="${index}">
                    ...
                    <td>
                        <input type="number" name="products[${index}][quantity]" class="form-control quantity-input" value="1" min="1" step="1" required>
                    </td>
                    <td>
        ...
        // Ensure whole-number quantities are submitted even if browser keeps values like 10.00.
