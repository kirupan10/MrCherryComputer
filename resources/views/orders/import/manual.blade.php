...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-list">
                        <a href="{{ shop_route('orders.import.bulk') }}" class="btn btn-outline-primary">
                ...
                <div>
                    ...
                    <div class="text-muted">
                        <ul class="mb-0">
                            ...
                            <li>For bulk imports, use the <a href="{{ shop_route('orders.import.bulk') }}" class="alert-link">CSV Import</a> feature.</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <form action="{{ shop_route('orders.import.store-manual') }}" method="POST" id="import-form">
            @csrf
