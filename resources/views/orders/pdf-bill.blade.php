...
<head>
    ...
    <style>
        @php
            ...
            $shopName = optional($order->shop)->name ?? config('app.name');
            $shopAddress = optional($order->shop)->address;
            $shopPhone = optional($order->shop)->phone;
            $shopEmail = optional($order->shop)->email;
        @endphp
...
<body>
    <div class="page">
        @if($hasLetterhead)
            ...
            ">
                {{ $shopEmail ?? 'Email not set' }} @if($shopPhone) | {{ $shopPhone }} @endif
            </div>
            @endif
            ...
            ">
                <table class="items-table" style="width: {{ $tableWidth }}px; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th style="width: {{ $tableWidth * 0.55 }}px; text-align: left; padding: 8px; background: #f5f5f5; border: 1px solid #ddd; font-size: 14px; font-weight: bold;">Item Details</th>
            ...
            ">
                ...
                <div style="margin-bottom: 3px;">Cheques to be drawn in favour of "{{ $shopName }}" and crossed ACCOUNT PAYEE ONLY.</div>
        ...
        @else
            ...
            <div style="padding: 20px;">
                ...
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 30px; border-bottom: 2px solid #000; padding-bottom: 20px;">
                    <div style="flex: 1;">
                        <div style="font-size: 18px; font-weight: bold; margin-bottom: 5px;">{{ $shopName }}</div>
                ...
                <table class="items-table" style="width: {{ $perfectTableWidth }}px; margin-bottom: 20px; border-collapse: collapse;">
                    <thead>
                        <tr>
                            <th style="width: 290px; text-align: left; padding: 10px; background: #f5f5f5; border: 1px solid #ddd; font-size: 13px; font-weight: bold;">Item Details</th>
                ...
                <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd;">
                    ...
                    <div style="font-size: 9px; line-height: 1.4; margin-bottom: 8px;">
                        Cheques to be drawn in favour of "{{ $shopName }}" and crossed ACCOUNT PAYEE ONLY.
                    </div>
