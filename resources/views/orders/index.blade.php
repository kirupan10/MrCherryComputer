...
@section('content')
    <div class="page-header d-print-none">
        ...
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ shop_route('pos.index') }}" class="btn d-none d-sm-inline-block">
    ...
    @if ($orders->isEmpty())
        <div class="container-fluid">
            <x-empty title="No orders found"
                ...
                button_label="{{ __('Add your first Order') }}" button_route="{{ shop_route('orders.create') }}" />
        </div>
    @else
        <div class="container-fluid">
            <x-alert />
            ...
            <div class="row">
                ...
                <form method="GET" action="{{ shop_route('orders.index') }}" id="filterForm">
                    <!-- Search and Date Filter Row -->
                            <div class="row g-2 mb-3">
                                ...
                                <div class="col-md-1 d-flex align-items-end">
                                    <a href="{{ shop_route('orders.index') }}" class="btn btn-outline-danger w-100" title="Reset Filters">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                ...
                                                <a href="{{ shop_route('orders.edit', $order) }}" class="btn btn-sm" title="Edit">
    ...
    <script>
        ...
        function fetchOrders(url = null) {
            ...
            const fetchUrl = url || `{{ shop_route('orders.index') }}?${params.toString()}`;
