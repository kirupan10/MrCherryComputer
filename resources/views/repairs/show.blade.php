...
@section('content')
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        @can('update', $repairJob)
                            <a href="{{ shop_route('tech.repairs.edit', $repairJob) }}" class="btn btn-outline-primary">
                        ...
                        @endcan
                        <a href="{{ shop_route('tech.repairs.print', $repairJob) }}" target="_blank" class="btn btn-outline-secondary">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="16" height="16"
                                viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            ...
                            <div class="card-body">
                                <div class="btn-list">
                                    ...
                                    @if($repairJob->status === 'pending')
                                        <form action="{{ shop_route('tech.repairs.start-diagnosis', $repairJob) }}" method="POST" class="d-inline">
                                            @csrf
                                    ...
                                    @if($repairJob->status === 'approved')
                                        <form action="{{ shop_route('tech.repairs.start-repair', $repairJob) }}" method="POST" class="d-inline">
                                            @csrf
                                    ...
                                    @if($repairJob->status === 'in_repair')
                                        <form action="{{ shop_route('tech.repairs.complete', $repairJob) }}" method="POST" class="d-inline">
                                            @csrf
                                    ...
                                    @if($repairJob->status === 'completed')
                                        <form action="{{ shop_route('tech.repairs.deliver', $repairJob) }}" method="POST" class="d-inline">
                                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p>
                                        @if($repairJob->customer)
                                            <a href="{{ shop_route('customer.show', $repairJob->customer) }}">
                                ...
                                @if($repairJob->serialNumber)
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p>
                                            <a href="{{ shop_route('tech.products.show', $repairJob->serialNumber->product) }}">
                                                {{ $repairJob->serialNumber->product->name }}
                                            </a><br>
                                            <small class="text-muted">
                                                SN:
                                                <a href="{{ shop_route('tech.serial-numbers.show', $repairJob->serialNumber) }}">
    ...
    @if(currentShop()->hasFeature('technician_assign'))
        ...
        <div class="modal fade" id="assignTechnicianModal" tabindex="-1">
            <div class="modal-dialog">
                <form action="{{ shop_route('tech.repairs.assign', $repairJob) }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="completeDiagnosisModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ shop_route('tech.repairs.approve', $repairJob) }}" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <div class="modal fade" id="addPartModal" tabindex="-1">
        <div class="modal-dialog">
            <form action="{{ shop_route('tech.repairs.parts.store', $repairJob) }}" method="POST">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
    ...
    @if(currentShop()->hasFeature('diagnostics'))
        ...
        <div class="modal fade" id="addDiagnosticModal" tabindex="-1">
            <div class="modal-dialog">
                <form action="{{ shop_route('tech.repairs.diagnostics.store', $repairJob) }}" method="POST">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
