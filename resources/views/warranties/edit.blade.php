...
<div class="page-body">
    <div class="container-xl">
        <div class="row row-deck row-cards">
            <form action="{{ shop_route('warranties.update', $warranty) }}" method="POST">
                @csrf
                @method('PUT')
                                    ...
                                    <div class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="text-muted small">Changes affect products</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="list-group-item px-0">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="text-muted small">Keep naming consistent</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="alert alert-info mb-0">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-muted">Editing this warranty will affect all products currently using it. Make sure changes are intentional.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                ...
                                                <div class="text-muted">
                                                    This warranty is currently assigned to {{ $warranty->products()->count() }} product(s).
                                                    Changes will affect all associated products.
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-footer text-end">
                                <div class="d-flex">
                                    <a href="{{ shop_route('warranties.index') }}" class="btn btn-link">Cancel</a>
