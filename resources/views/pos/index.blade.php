            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white shadow-sm rounded-lg p-4 sticky top-4">
                        ...
                        <!-- Cart Items -->
                        <div id="cart-items"
                            class="mb-4 max-h-64 overflow-y-auto border-t border-b border-gray-200 py-2">
                        ...
                        <div class="space-y-2 mb-4">
                            <div class="flex justify-between text-sm">
                                ...
                                <span class="font-medium">LKR <span id="subtotal">0.00</span></span>
                            </div>
                            <div class="flex justify-between text-sm">
                            ...
                            <div class="flex justify-between text-lg font-bold pt-2 border-t">
                                <span>Total:</span>
                                <span class="text-blue-600">LKR <span id="total-amount">0.00</span></span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <button onclick="openPaymentModal()" id="checkout-btn"
            ...
            <div class="mt-3">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" id="paid-amount" class="w-full border-gray-300 rounded-lg" min="0"
    ...
    @push('scripts')
        <script>
            ...
            function openPaymentModal() {
                ...
                document.getElementById('modal-total').value = `LKR ${total.toFixed(2)}`;
                document.getElementById('paid-amount').value = total.toFixed(2);
                document.getElementById('change-amount').value = 'LKR 0.00';
            ...
            function calculateChange() {
                ...
                document.getElementById('change-amount').value = `LKR ${change.toFixed(2)}`;
            }
            ...
            function completeSale() {
                ...
                if (Number.isNaN(paidAmount) || paidAmount < 0) {
                    alert('Paid amount must be zero or greater.');
                    return;
                }
