...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ shop_route('vendors.create') }}" class="btn btn-primary btn-lg px-4 py-2" style="font-weight: 600;">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form method="GET" action="{{ shop_route('vendors.index') }}" class="row g-2 align-items-end">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2">
                        ...
                        <a href="{{ shop_route('vendors.index', ['purchase_status' => 'pending']) }}" class="btn btn-secondary ms-2">Clear</a>
                        @endif
                    </div>
                </form>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-list justify-content-center">
                                            ...
                                            @endif
                                            <a href="{{ shop_route('vendors.show', $vendor->id) }}" class="btn btn-sm btn-ghost-primary">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            ...
                                            <a href="{{ shop_route('vendors.edit', $vendor->id) }}" class="btn btn-sm btn-ghost-warning">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                ...
                @else
                    <div class="empty">
                        ...
                        <div class="empty-action">
                            <a href="{{ shop_route('vendors.create') }}" class="btn btn-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    <line x1="12" y1="5" x2="12" y2="19"/>
                                    <line x1="5" y1="12" x2="19" y2="12"/>
