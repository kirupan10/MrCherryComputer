...
<div class="page-body">
    <div class="container-fluid">
        ...
        <form action="{{ shop_route('vendors.store') }}" method="POST">
            @csrf
            <div class="row">
                <!-- Main Form -->
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-footer text-end">
                            <a href="{{ shop_route('vendors.index') }}" class="btn btn-link">Cancel</a>
                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <div class="card-body">
                            <ul class="mb-0" style="font-size: 0.875rem; padding-left: 1.25rem;">
                                ...
                                <li class="mb-2">New suppliers are automatically set as Active</li>
