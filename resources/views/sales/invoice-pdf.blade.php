...
<body>
    ...
    <table class="totals">
        ...
        <tr><td><strong>Total</strong></td><td class="right"><strong>₹{{ number_format($sale->total_amount, 2) }}</strong></td></tr>
        <tr><td>Paid</td><td class="right">₹{{ number_format($sale->paid_amount, 2) }}</td></tr>
        <tr><td>Due</td><td class="right">₹{{ number_format($sale->due_amount, 2) }}</td></tr>
    </table>
</body>
</html>
