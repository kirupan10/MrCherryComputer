...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ shop_route('purchases.show', $creditPurchase->id) }}" class="btn btn-secondary btn-lg px-4 py-2" style="font-weight: 600;">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ shop_route('purchases.update', $creditPurchase->id) }}" method="POST" class="card">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-footer text-end">
                        <a href="{{ shop_route('purchases.show', $creditPurchase->id) }}" class="btn btn-secondary me-2">Cancel</a>
