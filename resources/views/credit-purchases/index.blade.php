...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form method="GET" action="{{ shop_route('purchases.index') }}" class="row g-2 align-items-end">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-1 d-flex flex-column align-items-end">
                        ...
                        <a href="{{ shop_route('purchases.index') }}" class="btn btn-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        <a href="{{ shop_route('purchases.show', $purchase->id) }}" class="btn btn-ghost-primary btn-icon" title="View">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12" cy="12" r="2"/><path d="M22 12c-2.667 4.667 -6 7 -10 7s-7.333 -2.333 -10 -7c2.667 -4.667 6 -7 10 -7s7.333 2.333 10 7"/></svg>
                                        </a>
                                        @if(!Auth::user()->isEmployee())
                                        <a href="{{ shop_route('purchases.edit', $purchase->id) }}" class="btn btn-ghost-warning btn-icon" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1"/><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z"/><path d="M16 5l3 3"/></svg>
                                        </a>
                                        @endif
                                        @if(in_array(Auth::user()->role, ['shop_owner', 'manager']))
                                        <form action="{{ shop_route('purchases.destroy', $purchase->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this purchase? This will remove all related payments and transactions.');">
                                            @csrf
                                            @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="11" class="text-center text-muted py-4">
                                    ...
                                    <a href="{{ shop_route('purchases.create') }}" class="btn btn-primary">Create First Purchase</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
