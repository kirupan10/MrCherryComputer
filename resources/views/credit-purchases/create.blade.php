...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ shop_route('purchases.store') }}" method="POST" class="card">
                    @csrf
                    ...
                    <div class="card-footer text-end">
                        <a href="{{ shop_route('purchases.index') }}" class="btn btn-secondary me-2">Cancel</a>
...
function submitCreateVendor() {
    ...
    fetch('{{ shop_route("vendors.store") }}', {
        method: 'POST',
        body: formData,
        headers: {
