                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="tax_percentage"
                                value="{{ old('tax_percentage', $product->tax_percentage) }}" step="0.01" min="0"
                                max="100" class="w-full border-gray-300 rounded-lg">
                        </div>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" rows="3"
                                class="w-full border-gray-300 rounded-lg">{{ old('description', $product->description) }}</textarea>
                        </div>
