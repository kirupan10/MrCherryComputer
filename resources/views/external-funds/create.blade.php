    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Add Liability</h2>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-info mb-0">
                            <div class="d-flex">
                                ...
                                <div>
                                    <strong>Important:</strong> All liabilities are tracked separately from your regular business transactions. They will appear in your financial reports under Liabilities section.
                                </div>
                            </div>
                        </div>
                    </div>
