    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ shop_route('expenses.create') }}" class="btn btn-white btn-lg px-4 py-2" style="font-weight: 600; letter-spacing: 0.5px; border: 2px solid #000;">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm">
                                            <a href="{{ shop_route('expenses.show', $expense) }}" class="btn btn-white" style="border: 1px solid #000;" title="View">
                                            ...
                                            <a href="{{ shop_route('expenses.edit', $expense) }}" class="btn btn-white" style="border: 1px solid #000;" title="Edit">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
        ...
        @empty
            <div class="card">
                <div class="card-body text-center py-5">
                    ...
                    <a href="{{ shop_route('expenses.create') }}" class="btn btn-white btn-md px-4" style="border: 2px solid #000;">
