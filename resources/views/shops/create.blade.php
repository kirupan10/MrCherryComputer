        ...
        <div class="col-md-8 mx-auto">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ request()->routeIs('admin.*') ? shop_route('admin.shops.store') : shop_route('shops.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="{{ request()->routeIs('admin.*') ? shop_route('admin.shops.index') : shop_route('shops.index') }}" class="btn">
