            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-list">
                        ...
                        <a href="{{ shop_route('returns.edit', $returnSale) }}" class="btn btn-primary">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="h4 mb-0">
                                    @if($returnSale->order)
                                        <a href="{{ shop_route('orders.show', $returnSale->order_id) }}" class="text-primary">
            ...
            <div class="modal-footer">
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col">
                            <form action="{{ shop_route('returns.destroy', $returnSale) }}" method="POST">
                                @csrf
                                @method('DELETE')
