<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            @can('return-create')
            <a href="{{ route('returns.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">
                Process Return
            </a>
            @endcan
        </div>
            ...
            <div class="bg-white shadow-sm rounded-lg p-4 mb-6">
                <form method="GET" action="{{ route('returns.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('returns.index') }}" class="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium py-2 px-4 rounded-lg text-center">
                            Clear
                        </a>
                    </div>
                </form>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('returns.show', $return) }}" class="text-blue-600 hover:text-blue-900">View</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
