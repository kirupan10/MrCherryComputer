<div class="card">
    <div class="card-header">
        ...
        <div class="card-actions">
            <x-action.create route="{{ shop_route('units.create') }}" />
        </div>
    </div>
            ...
            @forelse ($units as $unit)
                <tr>
                    ...
                    <td class="align-middle text-center" style="width: 10%">
                        <x-button.show class="btn-icon" route="{{ shop_route('units.show', $unit) }}"/>
                        <x-button.edit class="btn-icon" route="{{ shop_route('units.edit', $unit) }}"/>
                        <x-button.delete class="btn-icon" route="{{ shop_route('units.destroy', $unit) }}"/>
                    </td>
                </tr>
            @empty
                <tr>
