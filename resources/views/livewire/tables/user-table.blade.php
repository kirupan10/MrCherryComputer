                ...
                <tr>
                    ...
                    <td class="align-middle text-center" style="width: 10%">
                        <div class="btn-group" role="group">
                            <x-button.show class="btn-icon btn-sm" route="{{ shop_route('users.show', $user) }}"/>
                            <x-button.edit class="btn-icon btn-sm" route="{{ shop_route('users.edit', $user) }}"/>
                            @if(!$user->isSuperAdmin())
                                <x-button.delete class="btn-icon btn-sm" route="{{ shop_route('users.destroy', $user) }}"
