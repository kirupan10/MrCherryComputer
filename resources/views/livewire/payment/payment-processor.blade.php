            ...
            <div class="card-body">
                @if ($orderDetails)
                    ...
                    <div class="text-center mt-4">
                        <a href="{{ shop_route('orders.show', $orderDetails['order_id']) }}" class="btn btn-primary me-2" style="background: linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%); border: none; font-weight: 600; padding: 12px 24px; border-radius: 8px; box-shadow: 0 4px 12px rgba(59, 130, 246, 0.3); transition: all 0.3s ease;">
                            View Order Details
                        </a>
