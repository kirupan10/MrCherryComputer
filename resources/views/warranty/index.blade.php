    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <a href="{{ shop_route('warranty-claims.create') }}" class="btn btn-primary">
            ...
            <div class="col-12">
                @if($warrantyClaims->isEmpty())
                    <x-empty title="No warranty claims found"
                        ...
                        button_route="{{ shop_route('warranty-claims.create') }}" />
                @else
                    <x-alert />
                    ...
                    <div class="card">
                        ...
                        <div class="card-body border-bottom py-3">
                            <form method="GET" action="{{ shop_route('warranty-claims.index') }}" id="filterForm">
                                ...
                                <div class="row g-2">
                                    <div class="col-md-12 d-flex justify-content-between align-items-center">
                                        <a href="{{ shop_route('warranty-claims.index') }}" class="btn btn-outline-danger btn-sm">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="btn-list flex-nowrap">
                                                    <a href="{{ shop_route('warranty-claims.show', $claim->id) }}" class="btn btn-white btn-sm" title="View">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                    ...
                                                    <a href="{{ shop_route('warranty-claims.edit', $claim->id) }}" class="btn btn-white btn-sm" title="Edit">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                    ...
                                                    <form action="{{ shop_route('warranty-claims.destroy', $claim->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this warranty claim?');">
                                                        @csrf
                                                        @method('DELETE')
