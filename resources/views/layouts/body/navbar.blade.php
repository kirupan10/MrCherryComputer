            ...
            <ul class="navbar-nav">
                <li class="nav-item {{ request()->is('/') || request()->is('dashboard*') ? 'active' : null }}">
                    ...
                    <li class="nav-item {{ request()->is('pos') || request()->routeIs('orders.create') ? 'active' : null }}">
                        <a class="nav-link" href="{{ shop_route('orders.create') }}" >
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <div class="dropdown-header">Main Reports</div>
                                    <a href="{{ shop_route('reports.index') }}" class="dropdown-item">
                                    ...
                                    <a href="{{ shop_route('reports.transactions') }}" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    ...
                                    <a href="{{ shop_route('finance.index') }}" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <polyline points="12 3 20 7.5 20 16.5 12 21 4 16.5 4 7.5 12 3"/>
                                            <line x1="12" y1="12" x2="20" y2="7.5"/>
                                    ...
                                    <a href="{{ shop_route('finance.pnl-statement') }}" class="dropdown-item">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                ...
                                <div class="dropdown-menu-column">
                                    ...
                                    <a href="{{ shop_route('reports.sales.finance.credit-sales') }}" class="dropdown-item">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    @if(shop_route_exists('customers.index'))
                                    ...
                                    @endif
                                    @if(shop_route_exists('categories.index') && Auth::user()->hasInventoryAccess())
                                    ...
                                    <a class="dropdown-item" href="{{ shop_route('profile.settings') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M10.325 4.317c.426 -1.756 2.924 -1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543 -.94 3.31 .826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756 .426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543 -.826 3.31 -2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756 -2.924 1.756 -3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543 .94 -3.31 -.826 -2.37 -2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756 -.426 -1.756 -2.924 0 -3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94 -1.543 .826 -3.31 2.37 -2.37c1 .608 2.296 .07 2.572 -1.065z"/><path d="M9 12a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"/></svg>
                                        {{ __('Settings') }}
                                    </a>
                                    @endif
                                    @if(shop_route_exists('features') || \Route::has('permissions.index'))
                                    <div class="dropdown-header mt-1">Configuration</div>
                                    @endif
                                    @if(shop_route_exists('features'))
                                    <a class="dropdown-item" href="{{ shop_route('features') }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon dropdown-item-icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 21h18"/><path d="M5 21v-8"/><path d="M12 21v-14"/><path d="M19 21v-5"/></svg>
                                        {{ __('Features') }}
                                    </a>
                                    @endif
                                    @if(\Route::has('permissions.index') && !Auth::user()->isEmployee())
                                    <a class="dropdown-item {{ request()->routeIs('permissions.*') ? 'active' : '' }}" href="{{ shop_route('permissions.index') }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    navMenu.querySelectorAll('.nav-item.dropdown, .dropdown-menu').forEach(function(el) {
        el.classList.remove('show');
    });

    var toggles = navMenu.querySelectorAll('.nav-item.dropdown > .dropdown-toggle');
