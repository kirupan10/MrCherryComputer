            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    <div class="page-pretitle">
                        <a href="{{ shop_route('tech.serial-numbers.index') }}">Serial Numbers</a>
                    </div>
                    <h2 class="page-title">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ shop_route('tech.serial-numbers.edit', $serialNumber) }}" class="btn btn-primary">
                        ...
                        @can('delete', $serialNumber)
                            <form action="{{ shop_route('tech.serial-numbers.destroy', $serialNumber) }}"
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <p>
                                        <a href="{{ shop_route('tech.products.show', $serialNumber->product) }}">
                                ...
                                @if($serialNumber->customer)
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p>
                                            <a href="{{ shop_route('customer.show', $serialNumber->customer) }}">
                                ...
                                @if($serialNumber->order)
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p>
                                            <a href="{{ shop_route('order.show', $serialNumber->order) }}">
                                    ...
                                    <tbody>
                                        @foreach($serialNumber->warrantyClaims as $claim)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ shop_route('tech.warranty.show', $claim) }}" class="btn btn-sm btn-outline-primary">
                                                        View
                                                    </a>
                                                </td>
                                            </tr>
                        ...
                        <div class="card-body">
                            <div class="d-grid gap-2">
                                @if(currentShop()->hasFeature('warranty'))
                                    <a href="{{ shop_route('tech.warranty.create', ['serial_number_id' => $serialNumber->id]) }}"
                                ...
                                @if(currentShop()->hasFeature('repairs'))
                                    <a href="{{ shop_route('tech.repairs.create', ['serial_number_id' => $serialNumber->id]) }}"
                                        class="btn btn-outline-primary">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="16" height="16"
                                            viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round">
