...
@section('content')
        ...
        <div class="container-fluid">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ shop_route('tech.serial-numbers.show', $serialNumber) }}" class="btn btn-outline-primary">
    ...
    <div class="page-body">
        <div class="container-fluid">
            <form action="{{ shop_route('tech.serial-numbers.update', $serialNumber) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="{{ shop_route('tech.serial-numbers.show', $serialNumber) }}" class="btn">Cancel</a>
                                </div>
                            </div>
                        </div>
