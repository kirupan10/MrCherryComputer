        ...
        <div class="container-fluid">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ shop_route('tech.serial-numbers.create') }}" class="btn btn-primary d-none d-sm-inline-block">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-actions">
                        <form method="GET" action="{{ shop_route('tech.serial-numbers.index') }}" class="d-flex gap-2">
                            ...
                            @if(request()->hasAny(['search', 'status']))
                                <a href="{{ shop_route('tech.serial-numbers.index') }}" class="btn btn-sm">Clear</a>
                            @endif
                        </form>
                    </div>
                </div>
                        ...
                        <tbody>
                            @forelse($serialNumbers as $serial)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ shop_route('tech.products.show', $serial->product) }}">
                                            {{ $serial->product->name }}
                                        </a>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ shop_route('tech.serial-numbers.show', $serial) }}"
                                                class="btn btn-sm btn-primary">
                                                View
                                            </a>
                                            @can('update', $serial)
                                                <a href="{{ shop_route('tech.serial-numbers.edit', $serial) }}"
    ...
    <div class="modal fade" id="bulkImportModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ shop_route('tech.serial-numbers.bulk-import') }}" method="POST">
                    @csrf
