                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-actions">
                                    <a href="{{ shop_route('jobs.index') }}" class="btn-action">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                            <path d="M18 6l-12 12"/>
                                            <path d="M6 6l12 12"/>
                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <small class="form-hint">Manage job types in <a href="{{ shop_route('job-types.index') }}" class="text-primary">Jobs → Job Types</a></small>
                                            @error('job_type_id')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="card-footer text-end">
                                ...
                                <x-button.back route="{{ shop_route('jobs.index') }}">
                                    {{ __('Cancel') }}
                                </x-button.back>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer bg-light">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <a href="{{ shop_route('jobs.index') }}" class="btn btn-outline-secondary">
