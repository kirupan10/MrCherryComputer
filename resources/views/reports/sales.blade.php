        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="mt-2 text-3xl font-bold text-gray-900">₹{{ number_format($summary['total_sales'] ?? 0, 2) }}</div>
                </div>
                <div class="bg-white shadow-sm rounded-lg p-6">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="mt-2 text-3xl font-bold text-gray-900">₹{{ number_format($summary['average_sale'] ?? 0, 2) }}</div>
                </div>
                <div class="bg-white shadow-sm rounded-lg p-6">
                    <div class="text-sm font-medium text-gray-500">Total Tax Collected</div>
                    <div class="mt-2 text-3xl font-bold text-gray-900">₹{{ number_format($summary['total_tax'] ?? 0, 2) }}</div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">Sales by {{ ucfirst(request('group_by', 'day')) }}</h3>
                </div>
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Period</th>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Sales Count</th>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Average Sale</th>
                        </tr>
                    </thead>
