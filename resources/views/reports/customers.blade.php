        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                ...
                <div class="bg-white shadow-sm rounded-lg p-6">
                    ...
                    <div class="mt-2 text-3xl font-bold text-gray-900">₹{{ number_format($summary['total_revenue'] ?? 0, 2) }}</div>
                </div>
                <div class="bg-white shadow-sm rounded-lg p-6">
                    <div class="text-sm font-medium text-gray-500">Avg. Purchase Value</div>
                    <div class="mt-2 text-3xl font-bold text-gray-900">₹{{ number_format($summary['average_purchase'] ?? 0, 2) }}</div>
                </div>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase">Total Purchases</th>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Total Spent</th>
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Avg. Purchase</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">
                                ₹{{ number_format($customer['average_purchase'], 2) }}
                            </td>
                    ...
                    <tfoot class="bg-gray-50 font-semibold">
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900 text-right">
                                ₹{{ number_format($topCustomers->sum('total_spent'), 2) }}
                            </td>
                            <td colspan="2"></td>
                        </tr>
                    </tfoot>
