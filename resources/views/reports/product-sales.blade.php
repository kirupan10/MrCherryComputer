                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase">Average Price
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        @forelse($productSales as $index => $product)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 text-right">
                                    LKR {{ number_format($product['average_price'], 2) }}
                                </td>
                            </tr>
                        @empty
                            <tr>
                    ...
                    @if($productSales->count() > 0)
                        <tfoot class="bg-gray-50 font-semibold">
                            <tr>
                                ...
                                <td class="px-6 py-4 text-sm text-gray-900 text-right">
                                    LKR {{ number_format($productSales->sum('total_sales'), 2) }}
                                </td>
                                <td></td>
                            </tr>
                        </tfoot>
