    ...
    <div class="container-xl">
        <div class="px-0 mb-0 mt-2">
            <nav class="nav nav-borders">
                <a class="nav-link ms-0" href="{{ shop_route('profile.edit') }}">Profile</a>
                <a class="nav-link active" href="{{ shop_route('profile.settings') }}">Settings</a>
            </nav>
            <hr class="mt-0 mb-4" />
        </div>
    ...
    <div class="row">
        ...
        <div class="col-12 col-lg-8">
            <div class="card mb-4">
                ...
                <x-form action="{{ shop_route('password.update') }}" method="PUT">
                    <div class="card-body">
                        <div class="mb-3">
