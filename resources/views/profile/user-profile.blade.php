    ...
    <div class="container-xl">
        <div class="px-0 mb-0 mt-2">
            <nav class="nav nav-borders">
                <a class="nav-link ms-0 active" href="{{ shop_route('user.profile') }}">Profile</a>
        ...
        <div class="row row-cards">
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <form action="{{ shop_route('user.profile.update') }}" method="POST" enctype="multipart/form-data" id="photoForm">
                            @csrf
                            @method('patch')
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ shop_route('user.profile.update') }}" method="POST">
                            @csrf
                            @method('patch')
