                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pt-6 border-t border-gray-200">
                    ...
                    <div>
                        ...
                        <p class="text-base text-gray-900">
                            {{ optional($user->last_login_at)->format('d M, Y h:i A') ?? 'Never' }}</p>
                    </div>
                    <div>
            ...
            @if($user->hasRole('cashier'))
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div class="bg-white shadow-sm rounded-lg p-6">
                        ...
                        <div class="mt-2 text-3xl font-bold text-gray-900">{{ $stats['total_sales'] ?? 0 }}</div>
                    </div>
                    <div class="bg-white shadow-sm rounded-lg p-6">
                        <div class="text-sm font-medium text-gray-500">Sales Amount</div>
                        <div class="mt-2 text-3xl font-bold text-gray-900">LKR
                            {{ number_format($stats['sales_amount'] ?? 0, 2) }}</div>
                    </div>
                    <div class="bg-white shadow-sm rounded-lg p-6">
                        <div class="text-sm font-medium text-gray-500">Returns Processed</div>
                        <div class="mt-2 text-3xl font-bold text-gray-900">{{ $stats['returns_processed'] ?? 0 }}</div>
                    </div>
                </div>
