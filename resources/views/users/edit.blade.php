        ...
        <div class="row row-cards">
            ...
            <div class="col-lg-8">
                <div class="row row-cards">
                    ...
                    <div class="col-12">
                        <form action="{{ shop_route('users.update', $user) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            ...
                            <div class="card">
                                    ...
                                    <div class="row row-cards">
                                        <div class="col-md-12">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-hint">
                                                    <strong>Shop Owner:</strong> Full access to all features<br>
                                ...
                                <div class="card-footer text-end">
                                    ...
                                    <x-button.back route="{{ shop_route('users.index') }}">
                                        {{ __('Cancel') }}
                                    </x-button.back>
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <form action="{{ shop_route('users.updatePassword', $user) }}" method="POST">
                            @csrf
                            @method('put')
