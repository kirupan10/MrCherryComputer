    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center mb-3">
            ...
            <div class="col-auto ms-auto">
                <a href="{{ shop_route('job-types.create') }}" class="btn btn-primary">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="{{ shop_route('job-types.edit', $type) }}" class="btn btn-sm btn-white" title="Edit">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                ...
                                                <form action="{{ shop_route('job-types.destroy', $type) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this job type? This action cannot be undone.');">
                                                    @csrf
                                                    @method('DELETE')
