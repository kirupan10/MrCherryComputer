        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('vendors.show', $vendor->id) }}" class="btn btn-secondary btn-lg px-4 py-2">
                ...
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-footer text-end">
                            <a href="{{ route('vendors.show', $vendor->id) }}" class="btn btn-link">Cancel</a>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card border-danger">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('vendors.destroy', $vendor->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this supplier? This action cannot be undone.')">
                                @csrf
                                @method('DELETE')
