        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-list">
                        <a href="{{ route('vendors.edit', $vendor->id) }}" class="btn btn-warning btn-lg px-4 py-2">
                        ...
                        @if($vendor->creditPurchases->count() > 0)
                                ...
                                <table class="table table-vcenter card-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('purchases.show', $purchase->id) }}" class="btn btn-sm btn-ghost-primary">
                                                    View
                                                </a>
                                            </td>
                                        </tr>
                            ...
                            @if($vendor->creditPurchases->count() > 10)
                                <div class="card-footer">
                                    <a href="{{ route('purchases.index', ['search' => $vendor->name]) }}" class="btn btn-link">
                                        View All Purchases →
                                    </a>
                                </div>
                            @endif
