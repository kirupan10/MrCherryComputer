...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('cheques.show', $cheque) }}" class="btn btn-secondary btn-lg px-4 py-2" style="font-weight: 600;">
        ...
        <div class="row">
            <div class="col-lg-8">
                <form action="{{ route('cheques.update', $cheque) }}" method="POST" class="card">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-footer">
                        ...
                        <a href="{{ route('cheques.show', $cheque) }}" class="btn btn-ghost-secondary">Cancel</a>
                    </div>
                </form>
            </div>
