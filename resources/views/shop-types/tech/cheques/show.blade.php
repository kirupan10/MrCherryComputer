        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-list">
                        <a href="{{ route('cheques.edit', $cheque->id) }}" class="btn btn-warning btn-lg px-4 py-2" style="font-weight: 600;">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-wrap gap-2">
                            @if($cheque->status === 'pending')
                                <form action="{{ route('cheques.mark-deposited', $cheque) }}" method="POST" style="display: inline;">
                                    @csrf
                                ...
                                <form action="{{ route('cheques.mark-bounced', $cheque) }}" method="POST" style="display: inline;">
                                    @csrf
                            ...
                            @elseif($cheque->status === 'deposited')
                                <form action="{{ route('cheques.mark-cleared', $cheque) }}" method="POST" style="display: inline;">
                                    @csrf
