...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('cheques.create') }}" class="btn btn-primary btn-lg px-4 py-2" style="font-weight: 600;">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form method="GET" action="{{ route('cheques.index') }}" class="row g-2 align-items-end">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <a href="{{ route('cheques.index') }}" class="btn btn-secondary">Reset</a>
                    </div>
                </form>
            </div>
        </div>
                    ...
                    <tbody>
                        @forelse($cheques as $cheque)
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{{ route('cheques.status', $cheque) }}" style="display:inline-flex; align-items:center; gap:0.5rem;">
                                        @csrf
                                        @method('PATCH')
                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        <a href="{{ route('cheques.show', $cheque) }}" class="btn btn-ghost-primary btn-sm" title="View Details">
                                        ...
                                        <a href="{{ route('cheques.edit', $cheque) }}" class="btn btn-ghost-warning btn-sm" title="Edit">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        <form action="{{ route('cheques.destroy', $cheque) }}" method="POST" style="display: inline;" onsubmit="return confirm('Are you sure?')">
                                            @csrf
                                            @method('DELETE')
