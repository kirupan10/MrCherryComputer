...
@section('title', 'External Funds Report')
...
<div class="page-body">
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">All External Funds</h3>
            </div>
            <div class="table-responsive">
                <table class="table table-vcenter card-table table-striped">
                    ...
                    <tbody>
                        ...
                        @empty
                        <tr>
                            <td colspan="9" class="text-center text-muted py-4">No external funds recorded</td>
                        </tr>
                        @endforelse
                    </tbody>
                    @if($funds->count() > 0)
