    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('business-transactions.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <div class="ms-auto">
                            <form method="GET" action="{{ route('business-transactions.index') }}" class="d-flex gap-2">
                                ...
                                @if(request()->hasAny(['type', 'status', 'search', 'start_date', 'end_date']))
                                    <a href="{{ route('business-transactions.index') }}" class="btn btn-sm btn-secondary">Clear</a>
                                @endif
                            </form>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-list flex-nowrap">
                                                        <a href="{{ route('business-transactions.show', $transaction) }}" class="btn btn-sm" title="View">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"/><path d="M22 12c-2.667 4.667 -6 7 -10 7s-7.333 -2.333 -10 -7c2.667 -4.667 6 -7 10 -7s7.333 2.333 10 7"/></svg>
                                                        </a>
                                                        <a href="{{ route('business-transactions.edit', $transaction) }}" class="btn btn-sm" title="Edit">
