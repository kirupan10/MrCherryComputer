                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-list flex-nowrap">
                                                        <a href="{{ route('warranties.edit', $warranty) }}" class="btn btn-sm btn-white">
                                                            Edit
                                                        </a>
                                                        <form action="{{ route('warranties.destroy', $warranty) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this warranty?');">
                                                            @csrf
                                                            @method('DELETE')
