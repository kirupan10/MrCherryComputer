                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-list flex-nowrap justify-content-center">
                                                <a href="{{ route('credit-sales.show', $r->credit_sale_id) }}" class="btn btn-sm btn-white" style="border: 1px solid #000;" title="View Details">
                                                ...
                                                @endphp
                                                @if($creditSale)
                                                <a href="{{ route('credit-sales.download-pdf', $creditSale) }}" class="btn btn-sm btn-white" style="border: 1px solid #000;" title="Download PDF">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="16" height="16" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
