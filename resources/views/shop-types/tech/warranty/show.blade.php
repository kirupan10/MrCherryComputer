    ...
    <div class="container-fluid">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('warranty-claims.edit', $warrantyClaim->id) }}" class="btn btn-primary">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <a href="{{ route('orders.show', $warrantyClaim->order_id) }}" class="btn btn-outline-primary btn-sm mt-2">
                                    View Order Details
                                </a>
                            </div>
                        </div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <form action="{{ route('warranty-claims.destroy', $warrantyClaim->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this warranty claim? This action cannot be undone.');">
                            @csrf
                            @method('DELETE')
