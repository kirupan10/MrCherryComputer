            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="btn-list">
                        ...
                        <a href="{{ route('purchases.edit', $creditPurchase->id) }}" class="btn btn-warning btn-lg px-4 py-2" style="font-weight: 600;">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="col-lg-4">
                ...
                <div class="card bg-light-danger">
                    <div class="card-body">
                        ...
                        <form action="{{ route('purchases.destroy', $creditPurchase->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
...
<div class="modal modal-blur fade" id="recordPaymentModal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('purchases.record-payment', $creditPurchase->id) }}" method="POST">
                @csrf
