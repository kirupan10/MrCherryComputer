                ...
                <div class="col-12">
                    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('returns.create') }}" class="btn btn-white pos-quick-btn" title="Create Return">
...
`;
        ...
        function filterProducts() {
            ...
            productSearchTimeout = setTimeout(() => {
                ...
                fetch(`{{ route('orders.products') }}?search=${encodeURIComponent(searchTerm)}`)
                    .then(response => response.json())
                    .then(data => {
                        if (data.products && data.products.length > 0) {
                            renderProducts(data.products);
        ...
        function handlePrintReceipt() {
            ...
            const printUrlTemplate = @json(route('orders.receipt', ['order' => '__ORDER__']));
        ...
        async function downloadPdfReliably(orderId, invoiceNo, triggerButton = null) {
            ...
            const downloadUrlTemplate = @json(route('orders.download-pdf-bill', ['order' => '__ORDER__']));
