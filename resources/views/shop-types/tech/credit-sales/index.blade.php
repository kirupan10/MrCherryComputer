        ...
        <!-- Credit Sales Statistics -->
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="GET" action="{{ route('credit-sales.index') }}" class="row g-2 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <a href="{{ route('credit-sales.index', ['status' => 'unpaid']) }}" class="btn btn-secondary ms-2">Clear</a>
                                </div>
                            </form>
                        </div>
                    </div>
