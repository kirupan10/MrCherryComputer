...
<div class="page-body">
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('expenses.index') }}" class="btn btn-outline-secondary btn-lg px-4 py-2" style="font-weight: 600; letter-spacing: 0.5px;" title="View All Expenses">
                        ...
                        <a href="{{ route('deliveries.create') }}" class="btn btn-white btn-lg px-4 py-2" style="font-weight: 600; letter-spacing: 0.5px; border: 1px solid #000;">
        ...
        <div class="card mb-3">
            <div class="card-body">
                <form method="GET" action="{{ route('deliveries.index') }}" class="row g-2">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        ...
                        <a href="{{ route('deliveries.index') }}" class="btn btn-secondary">Clear</a>
                    </div>
                </form>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($delivery->expense_id)
                                            <a href="{{ route('expenses.edit', $delivery->expense_id) }}" class="badge bg-primary" target="_blank" title="View Expense" style="cursor: pointer;">
                                                #{{ $delivery->expense_id }}
                                            </a>
                                        @else
                                            <span style="color: #adb5bd;">-</span>
                                    ...
                                    <td>
                                        <div class="btn-list flex-nowrap">
                                            <a href="{{ route('deliveries.edit', $delivery) }}" class="btn btn-sm" title="Edit">
                                            ...
                                            <form action="{{ route('deliveries.destroy', $delivery) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this delivery?');" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="9" class="text-center py-5">
                                        <div style="color: #6c757d;">
                                            ...
                                            <a href="{{ route('deliveries.create') }}" class="btn btn-primary btn-md px-4">+ Add First Delivery</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
