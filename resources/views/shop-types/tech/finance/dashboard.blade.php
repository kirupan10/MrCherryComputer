                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <a href="{{ route('credit-sales.index') }}" class="btn btn-outline-warning">
                                    View Details
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-2">
                            <div class="col-6">
                                <a href="{{ route('expenses.create') }}" class="btn btn-outline-primary w-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            ...
                            <div class="col-6">
                                <a href="{{ route('business-transactions.create') }}" class="btn btn-outline-primary w-100">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon me-1" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                        <line x1="12" y1="5" x2="12" y2="19"/>
                                        <line x1="5" y1="12" x2="19" y2="12"/>
                            ...
                            <div class="col-6">
                                <a href="{{ route('expenses.index') }}" class="btn btn-outline-secondary w-100">View All Expenses</a>
                            </div>
                            <div class="col-6">
                                <a href="{{ route('business-transactions.index') }}" class="btn btn-outline-secondary w-100">View Transactions</a>
                            </div>
                        </div>
                    </div>
                </div>
