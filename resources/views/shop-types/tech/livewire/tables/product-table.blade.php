<div>
    ...
    <div class="alert alert-warning alert-dismissible fade show mb-4" role="alert">
        <div class="d-flex align-items-center">
            ...
            <div class="ms-3">
                <a href="{{ route('products.index') }}?filter=no_buying_price" class="btn btn-warning btn-sm">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-list flex-nowrap justify-content-center">
                                            ...
                                            @endif
                                            <a href="{{ route('barcode.print.product', $product) }}?quantity=1" target="_blank" class="btn btn-sm" title="Print Barcode">
