        ...
        <div class="container-fluid">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('tech.repairs.create') }}" class="btn btn-primary">
    ...
    <div class="page-body">
        <div class="container-fluid">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="GET" action="{{ route('tech.repairs.index') }}">
                        <div class="row g-2">
                            <div class="col-md-3">
                            ...
                            <div class="col-auto">
                                ...
                                <a href="{{ route('tech.repairs.index') }}" class="btn btn-link">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <table class="table card-table table-vcenter">
                        ...
                        <tbody>
                            @forelse($repairJobs as $job)
                                <tr>
                                    <td>
                                        <a href="{{ route('tech.repairs.show', $job) }}">
                                            #{{ $job->id }}
                                        </a>
                                    </td>
                                    <td>
                                        @if($job->customer)
                                            <a href="{{ route('customer.show', $job->customer) }}">
                                                {{ $job->customer->name }}
                                            </a><br>
                                    ...
                                    <td>
                                        @if($job->serialNumber)
                                            <a href="{{ route('tech.products.show', $job->serialNumber->product) }}">
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center text-muted py-4">
                                        ...
                                        <a href="{{ route('tech.repairs.create') }}">Create your first repair job</a>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
