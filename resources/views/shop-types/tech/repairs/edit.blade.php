...
@section('content')
            ...
            <div class="row g-2 align-items-center">
                <div class="col">
                    <div class="page-pretitle">
                        ...
                        <a href="{{ route('tech.repairs.show', $repairJob) }}">Job #{{ $repairJob->id }}</a>
                    </div>
                    <h2 class="page-title">
    ...
    <div class="page-body">
        <div class="container-fluid">
            <form action="{{ route('tech.repairs.update', $repairJob) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="{{ route('tech.repairs.show', $repairJob) }}" class="btn">Cancel</a>
                                </div>
                            </div>
                        </div>
